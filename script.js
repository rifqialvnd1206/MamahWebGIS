...
legend.onAdd = function () { 
    ...
    div.innerHTML =
        '<p style="font-size: 18px; font-weight: bold;">Legenda</p>' + 
        '<p style="font-size: 12px; font-weight: bold;">Infrastruktur</p>' + 
        '<div><svg style="display:block;margin:auto;text-align:center;"><circle cx="15" cy="8" r="5" fill="#9dfc03" /></svg></div>Jembatan<br>' +
        '<p style="font-size: 12px; font-weight: bold;">Batas Administrasi</p>'+ 
        '<div><svg><line x1="0" y1="11" x2="23" y2="11" style="stroke-width:2;stroke:rgb(0,0,0);stroke-dasharray:10 1 1 1"/></svg></div>Batas Desa/Kelurahan<br>'+ 
